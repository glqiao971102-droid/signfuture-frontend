...
const STAND_PRICE: number[] = [72.3, 60.3, 60.3, 60.3];

const REMARK_MAX = 200;

const money = (v: number) => "RM " + v.toFixed(2);

export default function HStandStraightProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/h-stand-straight-hero.png"
          alt="Custom H Stand (Straight) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">H Stand (Straight) Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ H Stand (Straight) added to cart — {money(agents[0].price)}</span>
