...
const PRICE: Record<string, Record<string, Record<string, Tier4>>> = {
  "Printing with Stand": {
    "3x3 (230cm X 344cm)": { "No Laminate": [1079.54, 1002.43, 1002.43, 1002.43], "Matt Lam 100micron": [1195.96, 1110.5, 1110.5, 1110.5], "Gloss Lam 100micron": [1195.96, 1110.5, 1110.5, 1110.5] },
    "4x3 (230cm X 414cm)": { "No Laminate": [1247.4, 1158.3, 1158.3, 1158.3], "Matt Lam 100micron": [1391.5, 1292.1, 1292.1, 1292.1], "Gloss Lam 100micron": [1391.5, 1292.1, 1292.1, 1292.1] },
  },
  "Printing with Accessories": {
    "3x3 (230cm X 344cm)": { "No Laminate": [646.8, 600.6, 600.6, 600.6], "Matt Lam 100micron": [763.2, 708.7, 708.7, 708.7], "Gloss Lam 100micron": [763.2, 708.7, 708.7, 708.7] },
    "4x3 (230cm X 414cm)": { "No Laminate": [794.5, 737.9, 737.9, 737.9], "Matt Lam 100micron": [938.8, 871.7, 871.7, 871.7], "Gloss Lam 100micron": [938.8, 871.7, 871.7, 871.7] },
  },
};
const STAND_ONLY: Record<string, Tier4> = {
  "3x3 (230cm X 344cm)": [793.1, 736.4, 736.4, 736.4],
  "4x3 (230cm X 414cm)": [887, 823.7, 823.7, 823.7],
};
