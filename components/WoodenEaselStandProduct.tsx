...
const STAND_PRICE: number[] = [66.3, 52.3, 52.3, 52.3];

const REMARK_MAX = 200;

const money = (v: number) => "RM " + v.toFixed(2);

export default function WoodenEaselStandProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/wooden-easel-stand-hero.png"
          alt="Custom Wooden Easel Stand — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Wooden Easel Stand Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Wooden Easel Stand added to cart — {money(agents[0].price)}</span>
