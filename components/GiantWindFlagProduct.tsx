...
export default function GiantWindFlagProduct() {
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: PRODUCT_NAME, href: PRODUCT_HREF, price: total, image: "/products/giant-wind-flag-hero.png", meta: `Finishing: ${finishing}${standOnly ? "" : ` · Printing: ${tech} · Side: ${side} · Material: ${material}`} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
