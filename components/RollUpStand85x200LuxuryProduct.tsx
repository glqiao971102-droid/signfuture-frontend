...
export default function RollUpStand85x200LuxuryProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Roll Up Stand 85cm x 200cm (Luxury)", href: "/catalog/roll-up-stand-85x200-luxury", price: total, image: "/products/roll-up-stand-85x200-luxury-hero.png", tierPrices: tierTotals, spec: { pricer: "stand", key: "roll-up-85x200-luxury", finishing, tech, lam, collect, qty }, meta: `Material: Synthetic Paper 180 Micron · Finishing: ${finishing} · Printing: ${tech} · Lamination: ${lam} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/roll-up-stand-85x200-luxury-hero.png"
          alt="Custom Roll Up Stand 85cm x 200cm (Luxury) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Roll Up Stand 85cm x 200cm (Luxury) Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Roll Up Stand 85cm x 200cm (Luxury) added to cart — {money(agents[0].price)}</span>
