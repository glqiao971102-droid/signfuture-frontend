...
const SIDE = [
  { label: "(W)145cm x (H)75cm (1 Side)",  w: 145, h: 75,  finish: "Welded edge with 16 eyelets" },
  { label: "(W)145cm x (H)160cm (2 Side)", w: 145, h: 160, finish: "Welded edge with 20 eyelets" },
];
...
const PRICE: Record<string, Record<string, Tier4>> = {
  "Printing with Stand": { "(W)145cm x (H)75cm (1 Side)": [264.1, 220.1, 220.1, 220.1], "(W)145cm x (H)160cm (2 Side)": [314, 261.7, 261.7, 261.7] },
  "Printing Only": { "(W)145cm x (H)75cm (1 Side)": [52.3, 43.5, 43.5, 43.5], "(W)145cm x (H)160cm (2 Side)": [102.2, 85.1, 85.1, 85.1] },
};
const STAND_ONLY_PRICE: Tier4 = [211.8, 176.5, 176.5, 176.5];
...
export default function AluminiumAboardStand80x150Product() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = () => {
    if (!agreed) return;
    add({ label: "Aluminium Aboard Stand 80cm x 150cm", href: "/catalog/aluminium-aboard-stand-80x150", price: total, image: "/products/aluminium-aboard-stand-80x150-hero.png" });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/aluminium-aboard-stand-80x150-hero.png"
          alt="Custom Aluminium Aboard Stand 80cm x 150cm — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Aluminium Aboard Stand 80cm x 150cm Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Aluminium Aboard Stand 80cm x 150cm added to cart — {money(agents[0].price)}</span>
