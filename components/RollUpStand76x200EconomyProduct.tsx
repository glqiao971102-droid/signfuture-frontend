...
export default function RollUpStand76x200EconomyProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Roll Up Stand 76cm x 200cm (Economy)", href: "/catalog/roll-up-stand-76x200-economy", price: total, image: "/products/roll-up-stand-76x200-economy-hero.png", tierPrices: tierTotals, spec: { pricer: "stand", key: "roll-up-76x200-economy", finishing, tech, lam, collect, qty }, meta: `Material: Synthetic Paper 180 Micron · Finishing: ${finishing} · Printing: ${tech} · Lamination: ${lam} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/roll-up-stand-76x200-economy-hero.png"
          alt="Custom Roll Up Stand 76cm x 200cm (Economy) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Roll Up Stand 76cm x 200cm (Economy) Order</h2>
          </div>
        ...
        <div className="xprod-summary-col">
          <aside className="xprod-summary">
            ...
            <div className="xprod-summary-list">
              ...
              <div className="xprod-sline"><span data-icon="⤢">Size</span><strong>75 x 200 cm</strong></div>
              <div className="xprod-sline"><span data-icon="▦">Total Area</span><strong>16.15 sq.ft.</strong></div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Roll Up Stand 76cm x 200cm (Economy) added to cart — {money(agents[0].price)}</span>
