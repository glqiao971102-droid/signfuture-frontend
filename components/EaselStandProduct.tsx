...
export default function EaselStandProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/easel-stand-hero.png"
          alt="Custom Easel Stand — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Easel Stand Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Easel Stand added to cart — {money(agents[0].price)}</span>
