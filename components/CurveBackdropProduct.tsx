...
const SEWING = ["Sewing with Zipper"];
...
const SIZE = [
  { label: '8 x 8 (2450mm (W) x 2330mm (H))',  w: 2450, h: 2330 },
  { label: '8 x 10 (3430mm (W) x 2330mm (H))', w: 3430, h: 2330 },
];
...
export default function CurveBackdropProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/curve-backdrop-hero.png"
