...
const PRODUCT_NAME = "Tension Fabric Promotion Table";
const PRODUCT_HREF = "/catalog/tension-fabric-promotion-table";
...
const SIZE = [
  { label: '216cm (W) x 106cm (H)', w: 2160, h: 1060 },
];
...
export default function TensionFabricPromotionTableProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: PRODUCT_NAME, href: PRODUCT_HREF, price: total, image: "/products/tension-fabric-promotion-table-hero.png", meta: `Finishing: ${finishing} · Material: ${MATERIAL} · Size: ${size} · Sewing Type: ${sewing} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/tension-fabric-promotion-table-hero.png"
