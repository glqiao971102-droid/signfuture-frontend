...
const DEFAULT_PRICE: Record<string, FinPrice> = {
  "Printing with Stand": { uv: [275.4, 257, 257, 257], eco: { none: [267, 249.2, 249.2, 249.2], lam: [296.4, 257, 257, 257] } },
  "Printing Only": { uv: [55.3, 51.6, 51.6, 51.6], eco: { none: [47, 43.8, 43.8, 43.8], lam: [76.1, 71.1, 71.1, 71.1] } },
};
const DEFAULT_STAND_ONLY: number[] = [206.3, 192.5, 192.5, 192.5];
...
export default function RollUpStand120x200LuxuryProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const _pricing = usePricingConfig("roll-up-120x200-luxury", { PRICE: DEFAULT_PRICE, STAND_ONLY_PRICE: DEFAULT_STAND_ONLY });
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Roll Up Stand 120cm x 200cm (Luxury)", href: "/catalog/roll-up-stand-120x200-luxury", price: total, image: "/products/roll-up-stand-120x200-luxury-hero.png", tierPrices: tierTotals, spec: { pricer: "stand", key: "roll-up-120x200-luxury", finishing, tech, lam, collect, qty }, meta: `Material: Synthetic Paper 180 Micron · Finishing: ${finishing} · Printing: ${tech} · Lamination: ${lam} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/roll-up-stand-120x200-luxury-hero.png"
          alt="Custom Roll Up Stand 120cm x 200cm (Luxury) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Roll Up Stand 120cm x 200cm (Luxury) Order</h2>
          </div>
        ...
        <div className="xprod-summary-col">
          <aside className="xprod-summary">
            ...
            <div className="xprod-summary-list">
              ...
              <div className="xprod-sline"><span data-icon="⤢">Size</span><strong>120 x 200 cm</strong></div>
              <div className="xprod-sline"><span data-icon="▦">Total Area</span><strong>25.83 sq.ft.</strong></div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Roll Up Stand 120cm x 200cm (Luxury) added to cart — {money(agents[0].price)}</span>
