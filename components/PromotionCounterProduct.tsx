...
export default function PromotionCounterProduct() {
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Promotion Counter", href: "/catalog/promotion-counter", price: total, image: "/products/promotion-counter-hero.png", meta: `Material: ${MATERIAL} · Finishing: ${finishing} · Lamination: ${lam} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
