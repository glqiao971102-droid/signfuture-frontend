...
export default function RollUpStand85x200EconomyProduct() {
  ...
  const addToCart = () => {
    if (!agreed) return;
    add({ label: "Roll Up Stand 85cm x 200cm (Economy)", href: "/catalog/roll-up-stand-85x200-economy", price: total, image: "/products/roll-up-stand-85x200-economy-hero.png", tierPrices: tierTotals });
    setAdded(true);
  };
