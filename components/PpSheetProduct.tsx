...
const HERO_IMAGE = "/products/pp-sheet-hero.png";
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src={HERO_IMAGE}
          alt="Custom PP Sheet — CNC Cut, premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head"><span className="xprod-head-icon" aria-hidden="true">▤</span><h2 className="xprod-stitle" data-kicker="Options">PP Sheet Order</h2></div>

          <div className="xprod-field" data-icon="▤">
            <label>Choose Material</label>
            <div className="xprod-fixedfield">PP Sheet</div>
          </div>
        ...
        <div className="xprod-summary-col">
          <aside className="xprod-summary">
            ...
            <div className="xprod-summary-list">
              <div className="xprod-sline"><span data-icon="▤">Material</span><strong>PP Sheet</strong></div>
