...
export default function StraightBackdropProduct() {
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: PRODUCT_NAME, href: PRODUCT_HREF, price: total, image: "/products/straight-backdrop-hero.png", meta: `Material: ${MATERIAL} · Finishing: ${finishing} · Side: ${side} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
