...
const PRODUCT_NAME = "Wind Flag 3.4m (Cross Base)";
const PRODUCT_HREF = "/catalog/wind-flag-34m-cross-base";
...
export default function WindFlagProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const total = BASE[finishing] * collectOpt.mult * (SIZE_MULT[size] || 1) * qty;
  const agents = [
    ...
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          ...
          alt="Custom Wind Flag (Cross Base) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <h2 className="xprod-stitle" data-kicker="Options">Wind Flag Order</h2>
          ...
          {/* Collect Date — 4 zoomable images (our design) */}
          ...
          {/* Upload artwork (below collect date) */}
        ...
        <div className="xprod-summary-col">
          <aside className="xprod-summary">
            ...
            <div className="xprod-summary-list">
              <div className="xprod-sline"><span>Material</span><strong>{standOnly ? "Stand only" : material}</strong></div>
              <div className="xprod-sline"><span>Sewing Type</span><strong>{standOnly ? "—" : sewing}</strong></div>
              <div className="xprod-sline"><span>Size</span><strong>{size}</strong></div>
              <div className="xprod-sline"><span>Finishing</span><strong>{finishing}</strong></div>
