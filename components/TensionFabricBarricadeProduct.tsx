...
const PRODUCT_NAME = "Tension Fabric Barricade";
const PRODUCT_HREF = "/catalog/tension-fabric-barricade";
...
const SIZE = [
  { label: '90cm x 150cm', w: 900, h: 1500 },
  { label: '90cm x 200cm', w: 900, h: 2000 },
];
...
export default function TensionFabricBarricadeProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: PRODUCT_NAME, href: PRODUCT_HREF, price: total, image: "/products/tension-fabric-barricade-hero.png", meta: `Finishing: ${finishing} · Printing: ${tech} · Side: ${side} · Material: ${MATERIAL} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/tension-fabric-barricade-hero.png"
