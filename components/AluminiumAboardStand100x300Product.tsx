...
const SIDE = [
  { label: "(W)295cm x (H)95cm (1 Side)",  w: 295, h: 95,  finish: "Welded edge with 24 eyelets" },
  { label: "(W)295cm x (H)200cm (2 Side)", w: 295, h: 200, finish: "Welded edge with 32 eyelets" },
];
...
export default function AluminiumAboardStand100x300Product() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/aluminium-aboard-stand-100x300-hero.png"
          alt="Custom Aluminium Aboard Stand 100cm x 300cm — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Aluminium Aboard Stand 100cm x 300cm Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Aluminium Aboard Stand 100cm x 300cm added to cart — {money(agents[0].price)}</span>
