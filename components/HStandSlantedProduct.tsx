...
const STAND_PRICE: number[] = [64.4, 53.6, 53.6, 53.6];

const REMARK_MAX = 200;

const money = (v: number) => "RM " + v.toFixed(2);

export default function HStandSlantedProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/h-stand-slanted-hero.png"
          alt="Custom H Stand (Slanted) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">H Stand (Slanted) Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ H Stand (Slanted) added to cart — {money(agents[0].price)}</span>
