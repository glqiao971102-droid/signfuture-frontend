...
const SIZE = ['30"(W) X 71"(H) with 4 Eyelet Only'];
...
export default function DoorBuntingStandProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Door Bunting Stand", href: "/catalog/door-bunting-stand", price: total, image: "/products/door-bunting-stand-hero.png", tierPrices: tierTotals, spec: { pricer: "stand", key: "door-bunting-stand", finishing, tech, lam, collect, qty }, meta: `Finishing: ${finishing}${standOnly ? "" : ` · Printing: ${tech} · Lamination: ${lam} · Size: ${size}`} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/door-bunting-stand-hero.png"
          alt="Custom Door Bunting Stand — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Door Bunting Stand Order</h2>
          </div>
        ...
        <div className="xprod-summary-col">
          <aside className="xprod-summary">
            ...
            <div className="xprod-summary-list">
              ...
              <div className="xprod-sline"><span data-icon="⤢">Size</span><strong>30 x 71 in</strong></div>
              <div className="xprod-sline"><span data-icon="▦">Total Area</span><strong>14.79 sq.ft.</strong></div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Door Bunting Stand added to cart — {money(agents[0].price)}</span>
