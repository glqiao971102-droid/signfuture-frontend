...
export default function RollUpStand85x200Luxury2SideProduct() {
  const { user } = useAuth();
  const { add } = useCart();
  ...
  const addToCart = async () => {
    ...
    add({ artworks, label: "Roll Up Stand 85cm x 200cm (Luxury) (2 Side)", href: "/catalog/roll-up-stand-85x200-luxury-2side", price: total, image: "/products/roll-up-stand-85x200-luxury-2side-hero.png", tierPrices: tierTotals, spec: { pricer: "stand", key: "roll-up-85x200-luxury-2side", finishing, tech, lam, collect, qty }, meta: `Material: Synthetic Paper 180 Micron · Finishing: ${finishing} · Printing: ${tech} · Lamination: ${lam} · Size: ${size} · Qty: ${qty} · ${collectOpt.label}` });
    setAdded(true);
  };
  ...
  return (
    <div className="xprod">
      ...
      <section className="xprod-hero">
        ...
        <img
          src="/products/roll-up-stand-85x200-luxury-2side-hero.png"
          alt="Custom Roll Up Stand 85cm x 200cm (Luxury) (2 Side) — premium quality"
      ...
      <div className="xprod-grid">
        ...
        <section className="xprod-panel">
          <div className="xprod-head">
            ...
            <h2 className="xprod-stitle" data-kicker="Options">Roll Up Stand 85cm x 200cm (Luxury) (2 Side) Order</h2>
          </div>
            ...
            <div className="xprod-order" style={{ border: 0, background: "transparent", boxShadow: "none", margin: 0, padding: 0 }}>
              ...
              {added && (
                <div className="xprod-added">
                  <span>✓ Roll Up Stand 85cm x 200cm (Luxury) (2 Side) added to cart — {money(agents[0].price)}</span>
