...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .preview-grid > .preview-panel { flex: 1 1 0; min-width: 0; height: 420px; }
    .preview-panel {
      min-width: 0;
...
function renderCollectDateOptions() {
  const dates = [
    ...
    ["normal", "1", "4 working days", "collect-date-4-working-days.png"],
    ["quick3", "1.2", "3 working days", "collect-date-3-working-days.png"],
    ["rush2", "1.35", "2 working days", "collect-date-2-working-days.png"],
    ["next", "1.7", "Next working days", "collect-date-next-working-days.png"],
  ];
